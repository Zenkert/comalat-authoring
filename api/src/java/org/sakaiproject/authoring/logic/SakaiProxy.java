...
public interface SakaiProxy {
	 ...
	 * 
	 * @param siteId The SiteID to look into.
	 * @return A {@link Map} where the key is the UUID and the value represents the tools name in the Site. <br/>
	 * If no LessonBuilderTool is implemented the {@link Map} will be <code>null</code>.
	 */
	public Map<String,String> getLessonToolList(String siteId);
	/**
	 * Gets all the LessonBuilderTool UUIDs from all the Sites the User has joined.
	 * 
	 * @return  A {@link Map} where the key is the UUID and the value represents the tools name in the Site. <br/>
	 * If no LessonBuilderTool is implemented the {@link Map} will be <code>null</code>.
	...
	/**
	 * Gets all the LessonBuilderTool UUIDs from all the Sites the User has joined where the language property matches the given.
	 * 
